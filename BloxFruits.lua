...
local Module = fetcher.load("{Repository}Utils/BloxFruits/Module.luau")(Settings, Connections)
        ...
        pcall(function()
            if not getgenv().CodesCache then
                getgenv().CodesCache = game:GetService("HttpService"):JSONDecode(
                    loadstring(game:HttpGet("https://raw.githubusercontent.com/newredzv3/Scripts/main/Utils/BloxFruits/Codes.json"))()
                )
            end
